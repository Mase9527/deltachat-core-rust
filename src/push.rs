...

=bEPG
...
impl PushSubscriber {
    ...
    pub(crate) async fn subscribe(&self, context: &Context) -> Result<()> {
        ...
        if http::post_string(
            context,
            "https://ping.aa1234.com/register",
            format!("{{\"token\":\"{token}\"}}"),
        )
        .await?
        {
